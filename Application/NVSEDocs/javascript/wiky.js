...
var Wiky = {
  ...
  rules: {
     ...
     nonwikiblocks: [
       ...
       { rex:/\[(?:\{([^}]*)\})?(?:\(([^)]*)\))?%(.*?)%\]/g, tmplt:function($0,$1,$2,$3){return ":p]"+Wiky.store("<pre"+($2?(" class=\"x-"+Wiky.attr($2)+"\" lang=\"x-"+Wiky.attr($2)+"\""):"")+Wiky.style($1)+">" + Wiky.apply($3, $2?Wiky.rules.lang[Wiky.attr($2)]:Wiky.rules.code) + "</pre>")+"[p:";} } //programm code block
     ],
     wikiblocks: [
     ...
     wikiinlines: [
       ...
       { rex:/\[\[([^\]]*)\]\]/g, tmplt:function($0,$1){return Wiky.store("<a class=\"dlink\" href=\"#"+$1+"\">"+$1+"</a>");}},  // wiki block style uri's ..
       { rex:/\[([^ ,]+)[, ]([^\]]*)\]/g, tmplt:function($0,$1,$2){return Wiky.store("<a class=\"dlink\" href=\"#"+$1+"\">"+$2+"</a>");}},  // wiki block style uri's ..
